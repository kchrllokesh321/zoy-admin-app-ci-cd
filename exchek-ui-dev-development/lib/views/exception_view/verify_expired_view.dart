...
class VerifyExpiredView extends StatelessWidget {
  const VerifyExpiredView({super.key});
  ...
  Widget _buildVerifyEmailHeader(BuildContext context) {
    return Column(
      ...
      children: [
        Text(
          Lang.of(context).lbl_verification_link_expired,
        ...
        buildSizedBoxH(14.0),
        Text(
          Lang.of(context).lbl_request_one_verify_email,
          style: Theme.of(context).textTheme.headlineMedium?.copyWith(
  ...
  Widget _buildBackButton(BuildContext context) {
    return Center(
      child: CustomElevatedButton(
        width: 200,
        text: Lang.of(context).lbl_back_to_signup_button,
        borderRadius: 20.0,
        ...
        onPressed: () {
          ...
          if (kIsWeb) {
            context.replace(RouteUri.signupRoute);
          } else {
            GoRouter.of(context).pushReplacement(RouteUri.signupRoute);
          }
        },
      ),
    );
