...
class PersonalBankAccountLinking extends StatelessWidget {
  const PersonalBankAccountLinking({super.key});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (state.isBankAccountVerify == true)
                      Form(
                        key: state.personalBankAccountVerificationFormKey,
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
  ...
  Widget _buildBankNumberField(BuildContext context, PersonalAccountSetupState state) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
        ...
        CustomTextInputField(
          ...
          onChanged: (value) {
            ...
            if (state.originalBankAccountNumber != null && value != state.originalBankAccountNumber) {
              context.read<PersonalAccountSetupBloc>().add(PersonalMarkBankAccountDataChanged());
            }
          },
  ...
  Widget _buildReEnterBankNumberField(BuildContext context, PersonalAccountSetupState state) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
          ...
          children: [
            ...
            CustomTextInputField(
              ...
              onFieldSubmitted: (value) {
                if (state.personalBankAccountVerificationFormKey.currentState?.validate() ?? false) {
                  context.read<PersonalAccountSetupBloc>().add(
                    PersonalBankAccountNumberVerify(
        ...
        builder: (context, child) {
          final isDisable =
              (state.bankAccountNumberController.text.isEmpty ||
                  ExchekValidations.validateBankAccount(state.bankAccountNumberController.text) != null) ||
              (state.reEnterbankAccountNumberController.text.isEmpty ||
                  ExchekValidations.validateAccountConfirmation(
                        state.bankAccountNumberController.text,
                        state.reEnterbankAccountNumberController.text,
                      ) !=
                      null) ||
              (state.ifscCodeController.text.isEmpty ||
                  ExchekValidations.validateIFSC(state.ifscCodeController.text) != null);
  ...
  Widget _buildVerifiedBankAccountNumber(BuildContext context, PersonalAccountSetupState state) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
          children: [
            ...
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () {
                  // Store original bank account number before enabling edit
                  context.read<PersonalAccountSetupBloc>().add(
                    PersonalStoreOriginalBankAccountNumber(state.bankAccountNumberController.text),
                  );
                },
                child: Text(
  ...
  Widget _buildVerifiedIFSCNumber(BuildContext context, PersonalAccountSetupState state) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  Widget _buildVerifiedAccountHolderName(BuildContext context, PersonalAccountSetupState state) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  Widget _buildBankAccountVerificationDocTypes(BuildContext context, PersonalAccountSetupState state) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
        ...
        ExpandableDropdownField(
          ...
          onChanged: (value) {
            context.read<PersonalAccountSetupBloc>().add(PersonalUpdateBankAccountVerificationDocType(value));
      ...
      builder: (context, state) {
        ...
        return CustomFileUploadWidget(
          ...
          onFileSelected: (fileData) {
            context.read<PersonalAccountSetupBloc>().add(PersonalUploadBankAccountVerificationFile(fileData: fileData));
            // Mark data as changed for bank account
            context.read<PersonalAccountSetupBloc>().add(PersonalMarkBankAccountDataChanged());
          },
          documentNumber: state.bankAccountNumber ?? '',
          documentType: _mapDocType(state.selectedBankAccountVerificationDocType, context),
          kycRole: "",
          screenName: "BANK",
        );
      },
