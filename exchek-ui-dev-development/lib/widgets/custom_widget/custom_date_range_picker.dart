...
class DateRange {
  ...
  bool get isCustom => presetName == null && startDate != null && endDate != null;
...
class _DatePickerPopupState extends State<_DatePickerPopup> {
                      ...
                      child: GestureDetector(
                        ...
                        child: Text(
                          ...
                          style: theme.textTheme.labelLarge?.copyWith(
                            ...
                            color: isSelected ? theme.customColors.primaryColor! : Color(0xFF19213D),
                            height: 1.2,
                          ),
                        ),
                      ),
                      ...
                      children: [
                        CustomElevatedButton(
                          ...
                          buttonStyle: ButtonStyle(
                            backgroundColor: WidgetStateProperty.all(Theme.of(context).customColors.fillColor),
                            foregroundColor: WidgetStateProperty.all(const Color(0xFF00CC73)),
                            shape: WidgetStateProperty.all(
                              RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(12),
                                side: BorderSide(color: const Color(0xFF00CC73), width: 1),
                              ),
                            ),
                        ...
                        CustomElevatedButton(
                          ...
                          borderRadius: 12.0,
                          buttonStyle: ButtonStyle(
                            backgroundColor: WidgetStateProperty.all(const Color(0xFF00CC73)),
                            foregroundColor: WidgetStateProperty.all(Theme.of(context).customColors.fillColor),
                            shape: WidgetStateProperty.all(
  ...
  Color? _getDateColor(DateTime date, bool isSelected, bool isInRange, ThemeData theme) {
    ...
    if (isInRange) return theme.customColors.daterangecolor;
    return null;
  }
